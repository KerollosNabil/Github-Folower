...
class AutolayoutHelper {
    ...
    func attatchScaledToWidth<T: NSLayoutXAxisAnchor> (anchor: NSLayoutAnchor<T>, toAnchor: NSLayoutAnchor<T>, constant: CGFloat, for sizeClasses: Set< DeviceSizeClassManager.DeviceSizeClass>, designOrientationIsPortrait: Bool) {
        let anchorConstraint = anchor.constraint(equalTo: toAnchor, constant: constant * designCalculator.widthFraction(isPortrait: designOrientationIsPortrait))
